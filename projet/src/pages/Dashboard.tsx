          ...
          <div className="mt-auto p-4">
            <Card>
              <CardHeader className="pb-4">
                ...
                <CardDescription>Unlock advanced features and get 24/7 support.</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <form>
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="Search door access logs..."
                  type="search"
                />
              </div>
            </form>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>The total number of users with access to the system.</CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-between">
